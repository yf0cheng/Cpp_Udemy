...
class Mystring
{
    ...
    friend Mystring operator*  (const Mystring &lhs, int a) ;
    friend Mystring & operator*=  (Mystring &lhs, int a);

    
    friend Mystring & operator++  (Mystring &lhs); // pre-increment   to uppercase
