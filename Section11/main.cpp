...
using namespace std;
void display_menu ();
void optionP(const vector<int>&);
void optionA(vector<int>&);
void optionM(const vector<int>&);
void optionS(const vector<int>&);
void optionL(const vector<int>&);
...
//        cout << selection<<endl;
        switch (selection){
            case 'P': optionP(numbers); break;
            case 'A': optionA(numbers); break;
            case 'M': optionM(numbers); break;
            case 'S': optionS(numbers); break;
            case 'L': optionL(numbers); break;
...
void optionP(const vector<int> &numbers){
    if (numbers.size() == 0)
...
void optionA(vector<int>&numbers){
    int num_to_add {};
...
void optionM(const vector<int>&numbers){
    if (numbers.size() == 0)
...
void optionS(const vector<int>& numbers){
    if (numbers.size() == 0) 
...
void optionL(const vector<int>&numbers){
    if (numbers.size() == 0)
